...
from ..cluster.cluster_eval import cluster_subheads_eval
from ..cluster.transforms import sobel_process
...
def segmentation_eval(config, net,
  ...
  stats_dict = cluster_subheads_eval(config, net,
                                     ...
                                     sobel=sobel, using_IR=using_IR, verbose=verbose,
...
def _segmentation_get_data(config, net, dataloader, sobel=False,
  ...
  num_batches = len(dataloader)  # =287 bach_sz=5
  num_samples = 0
